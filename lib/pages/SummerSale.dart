...
class SummerSale extends StatefulWidget {
  ...
  @override
  State<SummerSale> createState() => _SummerSaleState();
}
...
class _SummerSaleState extends State<SummerSale> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Summer Sales",style:TextStyle(
      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 30),
            ElevatedButton(onPressed: (){Summer();}, child: Text("Add",style: TextStyle(
              fontSize: 20,
              color: Colors.black,
            ),
            )
